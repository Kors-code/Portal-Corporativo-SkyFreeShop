...
| - "commissions" = comisiones personales
| - "budget.commissions" = configuración / cálculos / administración dentro de presupuesto
| - "budget.cashier" = vistas de premios / awards de cajeros
*/
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('api/v1')->middleware(['auth'])->group(function () {
        ...
        Route::prefix('commissions')->group(function () {
            ...
            Route::get('/by-seller/{userId}/export', [CommissionReportController::class, 'exportSellerDetail'])
                ->middleware('permission:budget.commissions.view');

            Route::get('/export', [CommissionReportController::class, 'exportExcel'])
                ->middleware('permission:budget.commissions.view');
