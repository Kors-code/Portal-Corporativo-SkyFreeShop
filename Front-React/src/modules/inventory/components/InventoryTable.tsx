                            ...
                            {filteredData.length === 0 ? (
                                ...
                                filteredData.map((item) => (
                                    <tr key={item.product_id}>
                                        ...
                                        <td style={td}>{formatNumber(item.existencia_final)}</td>
                                        ...
                                        <td style={td}>{item.dias_en_existencia ?? "-"}</td>
                                        <td style={td}>{item.fecha_ultima_venta ?? "-"}</td>
                                        <td style={td}>{item.dias_sin_ventas ?? "-"}</td>
