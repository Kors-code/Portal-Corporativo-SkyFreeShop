    ...
    public function getReport(?string $search = null, ?array $storeIds = null, ?string $asOfDate = null, ?int $maxMonths = null, ?array $productIds = null): array
    {
        ...
        $latestInventory = DB::connection('budget')->table('inventory as i')
            ...
            ->selectRaw('
                ...
                i.supplier,
                i.brand,
                COALESCE(i.costo_unitario, i.costo_unitario_usd, 0) as costo_unitario,
        ...
        $query = DB::connection('budget')
            ...
            ->select([
                ...
                DB::raw('COALESCE(inv.costo_unitario, p.cost_usd, p.avg_cost_usd, p.cost_unit, 0) as costo_unitario'),
        ...
        return $this->mergeLinkedLocations($query)->map(function ($row) use ($metricRange) {
            ...
            return [
                ...
                'cost_unitario' => (float) ($row->costo_unitario ?? 0),
