document.addEventListener("DOMContentLoaded", async () => {
 ...
 const motivos = [
  ...
  { codigo: 110, descripcion: "Utilizar dispositivos eléctronicos u otras objetos de uso personal en el lugar de trabajo" },
  ...
  { codigo: 116, descripcion: "Guardar mercancía en la tienda posterior a su facturación a excepción de la cancelación de vuelo" },
  { codigo: 117, descripcion: "No diligenciar correctamente los formatos aprobados para cada uno de los procesos" },
  { codigo: 118, descripcion: "No cumplir con el orden y aseo en zonas comunes de la compañía" },
  { codigo: 119, descripcion: "Saltarse los conductos regulares para la comunicación de información o solución de conflictos" },
  { codigo: 120, descripcion: "No cumplir con la debida marcación de la jornada laboral en el sistema" },
  ...
  { codigo: 216, descripcion: "No asistir a clases de ingles y no cumplir con las tareas, salvo personal que posea certificación de la competencia requerida en el perfi del cargo." },
  { codigo: 217, descripcion: "No realizar el cierre de caja en turno a la media noche" },
  { codigo: 218, descripcion: "No cumplr con las métricas de desempeño asignadas." },
  ...
  { codigo: 304, descripcion: "No saludar al personal del aeropuerto, compañeros, lideres y demás personal interno y externo a la compañía" },
  ...
  { codigo: 401, descripcion: "Falsificacion de documentos e información" },
  ...
  { codigo: 404, descripcion: "Destrucción, sustracción o apropiación de propiedad de DFP, de sus clientes o de sus empleados y/o ser cómplice de éstos." },
  ...
  { codigo: 406, descripcion: "Agresion física a partes interesadas (compañeros, clientes, proveedores, autoridades etc.)" },
  ...
  { codigo: 409, descripcion: "Aceptar dineros, obsequios o prevendas para favorecer a terceros." },
