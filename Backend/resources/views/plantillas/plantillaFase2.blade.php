  ...
  <style>
    ...
    body { margin:0; padding:0; font-family: DejaVu Sans, sans-serif; font-size: 12px; }
      .page {
        ...
        background-image: url("{{ public_path('baseFase2.png') }}");
    ...
    .fecha        { top: 40mm; left: 40mm; }
.nombre       { top: 52mm; left: 38mm; width: 120mm; }
.cedula       { top: 52mm; left: 152mm; width: 50mm; }
.cargo        { top: 62mm; left: 40mm; width: 160mm; }

.jefe         { top: 82mm; left: 50mm; width: 120mm; }
.jefe_cedula  { top: 82mm; left: 154mm; width: 50mm; }
.cargo_jefe   { top: 97mm; left: 35mm; width: 160mm; }

.fecha_evento { top: 128mm; left: 55mm; }
.hora         { top: 138mm; left: 34mm; }
.fase         { top: 138mm; left: 77mm; }
.grupo        { top: 138mm; left: 115mm; }
.orientacion  { top: 148mm; left: 80mm; width: 160mm; }
...
.firma_empleado        { top: 260mm; left: 20mm; width: 75mm; }
.firma_jefe        { top: 260mm; left: 130mm; width: 75mm; }
